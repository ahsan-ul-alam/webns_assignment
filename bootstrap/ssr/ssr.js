import { mergeProps, unref, useSSRContext, computed, resolveComponent, withCtx, renderSlot, onMounted, onUnmounted, ref, createVNode, createTextVNode, toDisplayString, openBlock, createBlock, createSSRApp, h as h$1 } from "vue";
import { renderToString } from "@vue/server-renderer";
import { usePage, createInertiaApp, Link, Head } from "@inertiajs/vue3";
import createServer from "@inertiajs/vue3/server";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderStyle, ssrRenderClass, ssrRenderList, ssrInterpolate } from "vue/server-renderer";
...
const logoSrc = "/build/assets/tickethub-qdoETEqX.webp";
const _sfc_main$9 = {
  __name: "TheLogo",
...
_sfc_main$9.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Layout/TheLogo.vue");
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center min-h-screen px-6 pt-6 bg-gray-100 sm:justify-center sm:pt-0" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$9, { class: "w-20 h-20 mb-2" }, null, _parent));
      _push(`<div class="w-full px-6 py-4 mt-6 overflow-hidden bg-white rounded-lg shadow-md sm:max-w-md">`);
...
const usePermission = ({ roles = [], permissions = [] }) => {
...
const _sfc_main$5 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_Link, mergeProps({
        href: __props.href,
        class: "block w-full px-4 py-2 text-sm text-gray-700 transition duration-150 ease-in-out text-start hover:bg-gray-100"
      }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ssrRenderSlot(_ctx.$slots, "default", {}, null, _push2, _parent2, _scopeId);
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    const props = __props;
    const computedClasses = computed(() => ({
      "block w-full ps-3 pe-4 py-2 border-l-4 text-start text-base text-medium transition duration-150 ease-in-out": true,
      "border-black text-black bg-gray-100 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700": props.active,
      "border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300 focus:outline-none focus:text-gray-800 focus:bg-gray-50 focus:border-gray-300": !props.active
    }));
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Link = resolveComponent("Link");
      _push(ssrRenderComponent(_component_Link, mergeProps({
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Link = resolveComponent("Link");
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "bg-white border-b border-gray-100" }, _attrs))}><div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8"><div class="flex justify-between h-16"><div class="flex"><div class="flex items-center shrink-0">`);
      _push(ssrRenderComponent(_component_Link, {
        href: _ctx.route("dashboard")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$9, { class: "w-12 h-12" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_sfc_main$9, { class: "w-12 h-12" })
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div><div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex lg:space-x-6"><!--[-->`);
      ssrRenderList(computedNavigationLinks.value, (link) => {
      ...
      _push(`<!--]--></div></div><div class="hidden sm:flex sm:items-center sm:ms-6"><div class="relative ms-3">`);
      ...
      _push(`<!--]--></div><div class="pt-4 pb-1 border-t border-gray-200"><div class="px-4"><div class="text-base font-medium text-gray-800">${ssrInterpolate(_ctx.$page.props.auth.user.name)}</div><div class="text-sm font-medium text-gray-500">${ssrInterpolate(_ctx.$page.props.auth.user.email)}</div></div><div class="mt-3 space-y-1">`);
      _push(ssrRenderComponent(_sfc_main$4, {
        href: _ctx.route("profile.edit")
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Layout/TheNavbar.vue");
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.type === "success") {
        _push(`<div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg"><svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z"></path></svg><span class="sr-only">Check icon</span></div>`);
      } else if (__props.type === "error") {
        _push(`<div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-lg"><svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20"><path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 11.793a1 1 0 1 1-1.414 1.414L10 11.414l-2.293 2.293a1 1 0 0 1-1.414-1.414L8.586 10 6.293 7.707a1 1 0 0 1 1.414-1.414L10 8.586l2.293-2.293a1 1 0 0 1 1.414 1.414L11.414 10l2.293 2.293Z"></path></svg><span class="sr-only">Error icon</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="ml-3 text-sm font-normal">${ssrInterpolate(props.message)}</div><button type="button" class="-mx-1.5 -my-1.5 ml-auto inline-flex h-8 w-8 rounded-lg bg-white p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-900 focus:ring-2 focus:ring-gray-300" data-dismiss-target="#toast-default" aria-label="Close"><span class="sr-only">Close</span><svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg></button></div>`);
    };
  }
};
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Shared/ToastListItem.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        class: "fixed bottom-4 right-4 z-[100] w-full max-w-xs space-y-4"
      }, _attrs))}>`);
      ssrRenderList(unref(toastStore).items, (item, index) => {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Components/Shared/ToastList.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen overflow-hidden bg-gray-100" }, _attrs))}>`);
      _push(ssrRenderComponent(_sfc_main$1, null, null, _parent));
      _push(ssrRenderComponent(_sfc_main$3, null, null, _parent));
      if (_ctx.$slots.header) {
        _push(`<header><div class="pt-6 mx-auto max-w-7xl sm:px-6 lg:px-8"><div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">`);
        ssrRenderSlot(_ctx.$slots, "header", {}, null, _push, _parent);
        _push(`</div></div></header>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<main><div class="px-6 pt-6 pb-12 mx-auto space-y-8 max-w-7xl lg:px-8">`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</div></main></div>`);
    };
  }
...
const appName = "Webns Ticket System";
createServer(
  (page) => createInertiaApp({
    page,
    render: renderToString,
    title: (title) => `${title} - ${appName}`,
    resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.vue": () => import("./assets/ConfirmPassword-CgYn8qq2.js"), "./Pages/Auth/ForgotPassword.vue": () => import("./assets/ForgotPassword-DIcrDJST.js"), "./Pages/Auth/Login.vue": () => import("./assets/Login-Dr41nRvl.js"), "./Pages/Auth/Register.vue": () => import("./assets/Register-RVOUQI65.js"), "./Pages/Auth/ResetPassword.vue": () => import("./assets/ResetPassword-Dv5nD3rb.js"), "./Pages/Auth/VerifyEmail.vue": () => import("./assets/VerifyEmail-C543qkwi.js"), "./Pages/Categories/Index.vue": () => import("./assets/Index-BNg5sZ9X.js"), "./Pages/Dashboard.vue": () => import("./assets/Dashboard-L14Cr04T.js"), "./Pages/Error.vue": () => import("./assets/Error-Y-1u6cnI.js"), "./Pages/Inboxes/Index.vue": () => import("./assets/Index-_2gyaLoi.js"), "./Pages/Labels/Index.vue": () => import("./assets/Index-Di_WpwlM.js"), "./Pages/Profile/Edit.vue": () => import("./assets/Edit-yRfIEO4L.js"), "./Pages/Tickets/Index.vue": () => import("./assets/Index-DAE9GlHy.js"), "./Pages/Tickets/Show.vue": () => import("./assets/Show-BOHLJJJZ.js"), "./Pages/Users/Index.vue": () => import("./assets/Index-Bjfv2WJG.js"), "./Pages/Welcome.vue": () => import("./assets/Welcome-B2s4iw9b.js") })),
    setup({ App, props, plugin }) {
      return createSSRApp({ render: () => h$1(App, props) }).component("Link", Link).component("Head", Head).component("GuestLayout", _sfc_main$8).component("AuthenticatedLayout", _sfc_main).use(plugin).use(P, {
        ...page.props.ziggy,
